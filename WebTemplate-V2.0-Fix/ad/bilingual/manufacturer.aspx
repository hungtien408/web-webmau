<%@ Page Title="" Language="C#" MasterPageFile="~/ad/template/adminEn.master" AutoEventWireup="true"
    CodeFile="manufacturer.aspx.cs" Inherits="ad_single_province" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphBody" runat="Server">
        ...
        <asp:Panel ID="pnlSearch" DefaultButton="btnSearch" runat="server">
            ...
            <table class="search">
                <tr>
                    ...
                    <td>
                        <asp:RadTextBox ID="txtSearchManufacturerName" runat="server" Width="500px" EmptyMessage="Tiêu đề ...">
                        </asp:RadTextBox>
                    </td>
                </tr>
            </table>
            ...
            <asp:LinkButton ID="btnCancel" runat="server" CommandName="CancelAll" Visible='<%# RadGrid1.EditIndexes.Count > 0 || RadGrid1.MasterTableView.IsItemInserted %>'><img class="vam" alt="" src="../assets/images/delete-icon.png" /> Hủy</asp:LinkButton>&nbsp;&nbsp;--%>
              ...
              <img class="vam" alt="" src="../assets/images/reload.png" /> Làm mới
                ...
                <Columns>
                    ...
                    <asp:GridBoundColumn HeaderText="Tiêu đề" DataField="ManufacturerName" SortExpression="ManufacturerName">
                    </asp:GridBoundColumn>
                        ...
                        <asp:Panel ID="Panel1" runat="server" DefaultButton="lnkUpdate">
                            ...
                            <table class="search">
                                <tr>
                                    ...
                                    <td>
                                        <asp:RadTextBox ID="txtManufacturerName" runat="server" Text='<%# Bind("ManufacturerName") %>'
    ...
    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" DeleteMethod="ManufacturerDelete"
        SelectMethod="ManufacturerSelectAll" TypeName="TLLib.Manufacturer" UpdateMethod="ManufacturerUpdate"
