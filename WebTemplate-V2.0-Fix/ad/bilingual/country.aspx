<%@ Page Title="" Language="C#" MasterPageFile="~/ad/template/adminEn.master" AutoEventWireup="true"
    CodeFile="country.aspx.cs" Inherits="ad_single_province" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphBody" runat="Server">
        ...
        <asp:Panel ID="pnlSearch" DefaultButton="btnSearch" runat="server">
            ...
            <table class="search">
                <tr>
                    ...
                    <td>
                        <asp:RadTextBox ID="txtSearchCountryName" runat="server" Width="500px" EmptyMessage="Tên Quốc gia ...">
                        </asp:RadTextBox>
                    </td>
                </tr>
            </table>
            ...
            <asp:LinkButton ID="btnCancel" runat="server" CommandName="CancelAll" Visible='<%# RadGrid1.EditIndexes.Count > 0 || RadGrid1.MasterTableView.IsItemInserted %>'><img class="vam" alt="" src="../assets/images/delete-icon.png" /> Hủy</asp:LinkButton>&nbsp;&nbsp;--%>
              ...
              <img class="vam" alt="" src="../assets/images/reload.png" /> Làm mới
                ...
                <Columns>
                    ...
                    <asp:GridBoundColumn HeaderText="Tên quốc gia" DataField="CountryName" SortExpression="CountryName">
                    </asp:GridBoundColumn>
                    ...
                    <asp:GridTemplateColumn HeaderText="Quận/Huyện">
                        <ItemTemplate>
                            <a href="province.aspx?ci=<%# Eval("CountryID") %>">Tỉnh/Thành (<%# Eval("NumOfProvince")%>)
                                &raquo; </a>
                        </ItemTemplate>
                    </asp:GridTemplateColumn>
                </Columns>
                        ...
                        <asp:Panel ID="Panel1" runat="server" DefaultButton="lnkUpdate">
                            ...
                            <table class="search">
                                <tr>
                                    ...
                                    <td>
                                        <asp:RadTextBox ID="txtCountryName" runat="server" Text='<%# Bind("CountryName") %>'
                                            Width="500px" EmptyMessage="Tên Quốc gia ...">
                                        </asp:RadTextBox>
                                    </td>
                                </tr>
                                <tr>
    ...
    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" DeleteMethod="CountryDelete"
        SelectMethod="CountrySelectAll" TypeName="TLLib.Country" 
        UpdateMethod="CountryUpdate" InsertMethod="CountryInsert">
        <DeleteParameters>
