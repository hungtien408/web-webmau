...
<asp:Content ID="Content2" ContentPlaceHolderID="cphBody" runat="Server">
                    ...
                    <asp:GridTemplateColumn DataField="ImageName" HeaderText="Ảnh" SortExpression="ImageName">
                        <ItemTemplate>
                            <asp:Panel ID="Panel1" runat="server" Visible='<%# string.IsNullOrEmpty( Eval("ImageName").ToString()) ? false : true %>'
                                Width="95">
                                <img id="Img1" alt="" src='<%# "~/res/project/thumbs/" + Eval("ImageName") %>' width="80"
                        ...
                        <asp:Panel ID="Panel1" runat="server" DefaultButton="lnkUpdate">
                            ...
                            <table class="search">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:RadComboBox Filter="Contains" ID="ddlProjectCategory" runat="server" DataSourceID="ObjectDataSource2"
    ...
    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="ProjectSelectAll"
        ...
        <SelectParameters>
            ...
            <asp:ControlParameter ControlID="txtSearchProjectTitle" Name="ProjectTitle" PropertyName="Text"
                Type="String" />
