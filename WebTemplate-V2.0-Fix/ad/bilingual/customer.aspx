<%@ Page Title="" Language="C#" MasterPageFile="~/ad/template/adminEn.master" AutoEventWireup="true"
    CodeFile="customer.aspx.cs" Inherits="ad_single_addressbook" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphBody" runat="Server">
    ...
    <asp:RadAjaxPanel ID="RadAjaxPanel1" runat="server">
        ...
        <asp:RadGrid ID="RadGrid1" AllowMultiRowSelection="True" runat="server" Culture="vi-VN"  DataSourceID="ObjectDataSource1"
            ...
            CssClass="grid" AllowAutomaticUpdates="True" AllowAutomaticInserts="True">
            ...
            <MasterTableView CommandItemDisplay="TopAndBottom" DataSourceID="ObjectDataSource1"
                ...
                <NestedViewTemplate>
                    ...
                    <asp:ObjectDataSource ID="OdsOrder" runat="server" SelectMethod="OrdersSelectAll1"
    ...
    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="AddressBookSelectAll"
        TypeName="TLLib.AddressBook" DeleteMethod="AddressBookDelete" UpdateMethod="AddressBookUpdate"
        InsertMethod="AddressBookInsert">
        <DeleteParameters>
