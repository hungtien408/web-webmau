<%@ Page Title="" Language="C#" MasterPageFile="~/ad/template/adminEn.master" AutoEventWireup="true"
    CodeFile="service.aspx.cs" Inherits="ad_single_service" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphBody" runat="Server">
        ...
        <asp:Panel ID="pnlSearch" DefaultButton="btnSearch" runat="server">
            ...
            <table class="search">
                <tr>
                    ...
                    <td>
                        <asp:RadTextBox ID="txtSearchServiceTitle" runat="server" Width="130px">
                        </asp:RadTextBox>
                    </td>
                    <td class="left">
                        Mô tả
                ...
                <tr>
                    ...
                    <td>
                        <asp:RadComboBox Filter="Contains" ID="ddlSearchCategory" runat="server" DataSourceID="ObjectDataSource2"
                            DataTextField="ServiceCategoryName" DataValueField="ServiceCategoryID" OnDataBound="DropDownList_DataBound"
                            Width="134px">
                        </asp:RadComboBox>
                    </td>
                    <td class="left">
        ...
        <asp:RadGrid ID="RadGrid1" AllowMultiRowSelection="True" runat="server" Culture="vi-VN" AllowPaging="True" 
            ...
            <MasterTableView CommandItemDisplay="TopAndBottom" DataSourceID="ObjectDataSource1"
                ...
                <Columns>
                    ...
                    <asp:GridBoundColumn HeaderText="ID" DataField="ServiceID" SortExpression="ServiceID">
                    </asp:GridBoundColumn>
                    <asp:GridBoundColumn DataField="ServiceTitle" HeaderText="Tiêu đề" SortExpression="ServiceTitle" />
                    <asp:GridBoundColumn DataField="ServiceTitleEn" HeaderText="Tiêu đề(En)" SortExpression="ServiceTitleEn" />
                    ...
                    <asp:GridTemplateColumn HeaderText="New" SortExpression="IsNew">
                        <ItemTemplate>
                            <asp:CheckBox ID="chkIsNew" runat="server" Checked='<%# string.IsNullOrEmpty(Eval("IsNew").ToString()) ? false : Eval("IsNew") %>'
                                CssClass="checkbox" />
                        </ItemTemplate>
                    </asp:GridTemplateColumn>
                    <asp:GridTemplateColumn HeaderText="Hot" SortExpression="IsHot">
                        <ItemTemplate>
                    ...
                    <asp:GridTemplateColumn DataField="ImageName" HeaderText="Ảnh" SortExpression="ImageName">
                        <ItemTemplate>
                            <asp:Panel ID="Panel1" runat="server" Visible='<%# string.IsNullOrEmpty( Eval("ImageName").ToString()) ? false : true %>'>
                                ...
                                <asp:LinkButton ID="lnkDeleteImage" runat="server" rel='<%#  Eval("ServiceID") + "#" + Eval("ImageName") %>'
                    ...
                    <FormTemplate>
                        <asp:Panel ID="Panel1" runat="server" DefaultButton="lnkUpdate">
                            ...
                            <div class="edit">
                                ...
                                &nbsp;&nbsp;
                                <asp:RadButton ID="RadButton2" runat="server" CommandName='Cancel' Text='Hủy'>
                            ...
                            <table class="search">
                                ...
                                <tr>
                                    <td class="left" colspan="2">
                                        ...
                                        &nbsp;&nbsp;
                                        <asp:CheckBox ID="chkIsNew" runat="server" CssClass="checkbox" Text=" New" Checked='<%# (Container is GridEditFormInsertItem) ? false : (string.IsNullOrEmpty(Eval("IsNew").ToString()) ? false : Eval("IsNew"))%>' />
                                        &nbsp;&nbsp;
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:RadTextBox ID="txtServiceTitle" runat="server" Text='<%# Bind("ServiceTitle") %>'
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:RadTextBox ID="txtMetaDescriptionEn" runat="server" Width="500px" Text='<%# Bind("MetaDescriptionEn") %>'
                                            EmptyMessage="Meta Description(En)...">
                                        </asp:RadTextBox>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <asp:RadTextBox ID="txtServiceTitleEn" runat="server" Text='<%# Bind("ServiceTitleEn") %>'
                                            Width="500px" EmptyMessage="Tiêu đề(En)...">
                                        </asp:RadTextBox>
                                    </td>
                                </tr>
                                <tr>
    ...
    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="ServiceSelectAll"
        TypeName="TLLib.Service" DeleteMethod="ServiceDelete" UpdateMethod="ServiceUpdate"
        InsertMethod="ServiceInsert">
        <DeleteParameters>
        ...
        <SelectParameters>
            ...
            <asp:ControlParameter ControlID="txtSearchServiceTitle" Name="ServiceTitle" PropertyName="Text"
                Type="String" />
            <asp:ControlParameter ControlID="txtSearchDescription" Name="Description" PropertyName="Text"
                Type="String" />
            <asp:ControlParameter ControlID="ddlSearchCategory" Name="ServiceCategoryID" PropertyName="SelectedValue"
                Type="String" />
    ...
    <asp:ObjectDataSource ID="ObjectDataSource2" runat="server" SelectMethod="ServiceCategorySelectAll"
