<%@ Page Title="" Language="C#" MasterPageFile="~/ad/template/adminEn.master" AutoEventWireup="true"
    CodeFile="servicecategory.aspx.cs" Inherits="ad_single_servicecategory" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphBody" runat="Server">
        ...
        <asp:RadGrid ID="RadGrid1" AllowMultiRowSelection="True" runat="server" Culture="vi-VN" 
            ...
            <MasterTableView CommandItemDisplay="TopAndBottom" DataSourceID="ObjectDataSource1"
                ...
                <Columns>
                    ...
                    <asp:GridTemplateColumn DataField="ServiceCategoryName" HeaderText="Tên danh mục">
                        <ItemTemplate>
                            <div class='<%#"catlevel level" +  Eval("Level") %>' style='padding-left: <%# string.IsNullOrEmpty(Eval("Level").ToString()) ? 0 : Convert.ToInt32(Eval("Level")) * 10 %>px'>
                                <asp:Label ID="lblServiceCategoryName" runat="server" Font-Bold='<%# Eval("ParentID").ToString() == "0" ? true : false %>'
                                    Text='<%# Eval("ServiceCategoryName")%>'></asp:Label>
                            </div>
                        </ItemTemplate>
                        ...
                        <ItemTemplate>
                            <div class='<%#"catlevel level" +  Eval("Level") %>' style='padding-left: <%# string.IsNullOrEmpty(Eval("Level").ToString()) ? 0 : Convert.ToInt32(Eval("Level")) * 10 %>px'>
                                <asp:Label ID="lblServiceCategoryNameEn" runat="server" Font-Bold='<%# Eval("ParentID").ToString() == "0" ? true : false %>'
                                    Text='<%# Eval("ServiceCategoryNameEn")%>'></asp:Label>
                            </div>
                        </ItemTemplate>
                    </asp:GridTemplateColumn>
                    <asp:GridBoundColumn DataField="ServiceCategoryID" HeaderText="ID" SortExpression="ServiceCategoryID">
                    </asp:GridBoundColumn>
                    <asp:GridTemplateColumn>
                        <ItemTemplate>
                            <div style="line-height: 10px; padding: 0 10px 0 10px;">
                                <asp:LinkButton ID="lnkUpOrder" runat="server" OnClick="lnkUpOrder_Click" rel='<%# Eval("ServiceCategoryID") %>'>
                                    <img alt="" title="Lên 1 cấp" src="../assets/images/up-arrow.gif" />
                                </asp:LinkButton>
                                <asp:LinkButton ID="lnkDownOrder" runat="server" OnClick="lnkDownOrder_Click" rel='<%# Eval("ServiceCategoryID") %>'>
                        ...
                        <asp:Panel ID="Panel1" runat="server" DefaultButton="lnkUpdate">
                            ...
                            <table class="search">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:RadComboBox ID="ddlParent" runat="server" DataSourceID='<%# (Container is GridEditFormInsertItem) ? "ObjectDataSource1" : "ObjectDataSource2" %>'
                                            DataTextField="ServiceCategoryName" DataValueField="ServiceCategoryID" Filter="Contains"
                                            OnDataBound="DropDownList_DataBound" Width="504px">
                                        </asp:RadComboBox>
                                        <asp:ObjectDataSource ID="ObjectDataSource2" runat="server" SelectMethod="ServiceCategoryForEditSelectAll"
                                            TypeName="TLLib.ServiceCategory">
                                            <SelectParameters>
                                                <asp:ControlParameter ControlID="hdnServiceCategoryID" Name="ServiceCategoryID" PropertyName="Value"
                                                    Type="String" />
                                            </SelectParameters>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:RadTextBox ID="txtServiceCategoryName" runat="server" Text='<%# (Container is GridEditFormInsertItem) ? "" : (string.IsNullOrEmpty(Eval("ServiceCategoryName").ToString()) ? "" : Eval("ServiceCategoryName").ToString().Remove(0, Convert.ToInt32(Eval("Level")))) %>'
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:RadTextBox ID="txtServiceCategoryNameEn" runat="server" Text='<%# (Container is GridEditFormInsertItem) ? "" : Eval("ServiceCategoryNameEn") %>'
    ...
    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" DeleteMethod="ServiceCategoryDelete"
        SelectMethod="ServiceCategorySelectAll" TypeName="TLLib.ServiceCategory" UpdateMethod="ServiceCategoryUpdate"
        InsertMethod="ServiceCategoryInsert">
        <DeleteParameters>
            <asp:Parameter Name="ServiceCategoryID" Type="String" />
        </DeleteParameters>
        <InsertParameters>
            <asp:Parameter Name="ServiceCategoryName" Type="String" />
            <asp:Parameter Name="ServiceCategoryNameEn" Type="String" />
            <asp:Parameter Name="ConvertedServiceCategoryName" Type="String" />
