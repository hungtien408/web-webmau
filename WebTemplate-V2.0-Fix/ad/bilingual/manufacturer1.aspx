<%@ Page Title="" Language="C#" MasterPageFile="~/ad/template/adminEn.master" AutoEventWireup="true"
    CodeFile="manufacturer1.aspx.cs" Inherits="ad_single_partner" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphBody" runat="Server">
    ...
    <asp:RadAjaxPanel ID="RadAjaxPanel1" runat="server" ClientEvents-OnRequestStart="conditionalPostback">
        <asp:Panel ID="pnlSearch" DefaultButton="btnSearch" runat="server">
            ...
            <table class="search">
                <tr>
                    ...
                    <td>
                        <asp:RadTextBox ID="txtSearchManufacturerName" runat="server" Width="200px">
                        </asp:RadTextBox>
                    </td>
                </tr>
            </table>
                ...
                <Columns>
                    ...
                    <asp:GridTemplateColumn HeaderStyle-Width="1%" HeaderText="STT">
                        <ItemTemplate>
                            ...
                            <asp:HiddenField ID="hdnManufacturerImage" runat="server" Value='<%# Eval("ManufacturerImage") %>' />
                        </ItemTemplate>
                    </asp:GridTemplateColumn>
                    <asp:GridBoundColumn HeaderText="ID" DataField="ManufacturerID" SortExpression="ManufacturerID">
                    </asp:GridBoundColumn>
                    <asp:GridTemplateColumn HeaderText="Tên Nhà Sản Xuất" DataField="ManufacturerName"
                        SortExpression="ManufacturerName">
                        <ItemTemplate>
                            <asp:Label ID="lblManufacturerName" runat="server" Text='<%# Eval("ManufacturerName")%>'></asp:Label>
                        </ItemTemplate>
                    </asp:GridTemplateColumn>
                    <asp:GridTemplateColumn HeaderText="Tên Nhà Sản Xuất(Tiếng Anh)" Visible="false"
                        DataField="ManufacturerNameEn" SortExpression="ManufacturerNameEn">
                        <ItemTemplate>
                    ...
                    <asp:GridTemplateColumn DataField="ManufacturerImage" HeaderText="Ảnh"
                        SortExpression="ManufacturerImage">
                        <ItemTemplate>
                            <asp:Panel ID="Panel1" runat="server" Visible='<%# string.IsNullOrEmpty( Eval("ManufacturerImage").ToString()) ? false : true %>'
                                Width="95">
                                <img alt="" src='<%# "~/res/manufacturer/" + Eval("ManufacturerImage") %>' width="80"
                                    runat="server" visible='<%# string.IsNullOrEmpty(Eval("ManufacturerImage").ToString()) ? false : true %>' />
                                <asp:LinkButton ID="lnkDeleteImage" runat="server" rel='<%#  Eval("ManufacturerID") + "#" + Eval("ManufacturerImage") %>'
                            ...
                            <table class="search">
                                <tr>
                                    ...
                                    <td>
                                        <asp:HiddenField ID="hdnManufacturerID" runat="server" Value='<%# Eval("ManufacturerID") %>' />
                                        <asp:HiddenField ID="hdnManufacturerImage" runat="server" Value='<%# Eval("ManufacturerImage") %>' />
                                        <asp:RadUpload ID="FileManufacturerImage" runat="server" ControlObjectsVisibility="None"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtManufacturerName" runat="server" Text='<%# Bind("ManufacturerName") %>'
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtManufacturerNameEn" runat="server" Text='<%# Bind("ManufacturerNameEn") %>'
                                            Width="500px"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
        ...
        <asp:RadInputManager ID="RadInputManager1" runat="server">
            <asp:TextBoxSetting EmptyMessage="Tên Nhà Sản Xuất ...">
                <TargetControls>
                    <asp:TargetInput ControlID="txtManufacturerName" />
                </TargetControls>
            </asp:TextBoxSetting>
            <asp:TextBoxSetting EmptyMessage="Tên Nhà Sản Xuất(En) ...">
                <TargetControls>
                    <asp:TargetInput ControlID="txtManufacturerNameEn" />
                </TargetControls>
            </asp:TextBoxSetting>
    ...
    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" DeleteMethod="ManufacturerDelete"
        SelectMethod="ManufacturerSelectAll" TypeName="TLLib.Manufacturer1" UpdateMethod="ManufacturerUpdate"
        InsertMethod="ManufacturerInsert">
        <DeleteParameters>
            <asp:Parameter Name="ManufacturerID" Type="String" />
        </DeleteParameters>
        <InsertParameters>
            <asp:Parameter Name="ManufacturerName" Type="String" />
            <asp:Parameter Name="ManufacturerNameEn" Type="String" />
            <asp:Parameter Name="ConvertedManufacturerName" Type="String" />
            <asp:Parameter Name="ManufacturerImage" Type="String" />
        ...
        <SelectParameters>
            <asp:ControlParameter ControlID="txtSearchManufacturerName" Name="ManufacturerName"
